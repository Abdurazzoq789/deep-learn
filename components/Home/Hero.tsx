...
export default function Hero() {
  const features = [
    {
      ...
      title: "AI teacher",
      description:
        "This fully automated AI tutor allows you to practice speaking, improve your grammar, and expand your vocabulary in a foreign language. It never gets tired, bored, or impatient – always ready to support your learning.",
    },
    {
      icon: <CloudServerOutlined />,
      title: "Essay checking",
      description:
        "Written an assignment in a foreign language but have no way to evaluate it? With our platform, just submit your text and get instant feedback and scoring – no teacher required.",
    },
    {
      icon: <CodeOutlined />,
      title: "AI detector",
      description:
        "Now it’s no longer a challenge to determine whether your student’s writing was generated by AI or written by themselves – simply submit the text and get the result instantly.",
    },
  ];
  ...
  return (
    <>
      <HeroContainer>
        <ContentWrapper>
          <StyledTitle level={1}>Deep Learn</StyledTitle>
          <StyledParagraph>
